...
MODEL                = uncontrolled
MODULES              = rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c uncontrolled.c uncontrolled_capi.c uncontrolled_data.c uncontrolled_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = uncontrolled.exe
MAKEFILE             = uncontrolled.mk
...
START_DIR            = C:/Users/loren/Desktop/sadc-final-project/code
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = uncontrolled_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/uncontrolled \
